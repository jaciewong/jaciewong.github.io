...
// Fullscreen toggling
const enterFSbtn = document.querySelector("#enterFSbtn");
const exitFSbtn = document.querySelector("#exitFSbtn");
...
function exitFullscreen() {
    ...
    enterFSbtn.style.display = "inline-block";
    exitFSbtn.style.display = "none";
}

// show only enter FS button initially
enterFSbtn.style.display = "inline-block";
exitFSbtn.style.display = "none";